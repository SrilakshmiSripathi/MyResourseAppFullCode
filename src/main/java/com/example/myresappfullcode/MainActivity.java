package com.example.myresappfullcode;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPickedAuthorQuote.setText(R.string.defaultquote);
        //END
